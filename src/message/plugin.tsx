...
const setMessageConfig: MessageConfigMethod = (options) => {
  options.attach && (defaultMessageOptions.attach = options.attach);
  options.duration && (defaultMessageOptions.duration = options.duration);
  options.placement && (defaultMessageOptions.placement = options.placement);
  options.zIndex && (defaultMessageOptions.zIndex = options.zIndex);
};
